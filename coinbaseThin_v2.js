...
ws.onmessage = (fmsg) => {
  ...
  //console.log(msg)
  console.log(msg['trade_id'] +' & '+ ddatetime+' & '+msg['time']+' & '+ msg['product_id']+' & '+msg['side']+' & '+msg['size']+' & '+msg['price']+' & '+msg['maker_order_id']+' & '+msg['taker_order_id']+' & '+ msg['sequence']+" \\")
  //console.log(ddatetime+' & '+msg['time']+' & '+ msg['product_id'] +' & '+ msg['last_trade_id'] +' & '+ msg['sequence']+" \\")
};
